  ...
  <div id="record-list">
    <Card>
      ...
      <Card class="table-card">
          ...
          <Form :label-width="80">
            <FormItem label="columnsBox" prop="columnsBox">
              <CheckboxGroup v-model="columnsBox">
                <Checkbox label="partModel">型号</Checkbox>
                <Checkbox label="partName">名称</Checkbox>
        ...
        <Table :loading="loading" :columns="columns" :data="data" border :no-data-text="tableText" show-summary :summary-method="handleSummary" />
        <br>
  ...
  methods: {
    ...
    handleSummary ({ columns, data }) {
      ...
      columns.forEach((column, index) => {
        ...
        console.log(key)
        if (key !== 'barCode' & !values.every(value => isNaN(value))) {
